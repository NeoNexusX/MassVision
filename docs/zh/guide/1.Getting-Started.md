...
- **查找数据集**：介绍公开数据集与个人数据集的搜索、筛选方式，以及数据集列表的排序模式。
- **数据集总览**：介绍数据集详情页的基本信息构成，以及如何下载原始数据、生成并复制公开分享链接。
- **数据可视化**：介绍结果页中离子图、TIC 图与质谱图的查看方式，涵盖 UMAP/KMeans 聚类、ROI 圈选、区域比较与注释匹配等空间分析操作。
- **上传数据集**：介绍 imzML/ibd 文件对的上传流程与元数据填写规范，以及自动查重、分片上传与断点续传机制。
- **数据集分析**：介绍如何根据数据的 spectrum/storage mode 选择兼容的预处理方法，配置参数并提交分析任务。
