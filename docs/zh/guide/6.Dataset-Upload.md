...
点击`Choose Files`后选择本地的.imzml和.ibd文件进行上传，要求两文件必须同名。
...
![image-20260908193210268](https://official-oss.oss-cn-hongkong.aliyuncs.com/docs/20260908175221284.jpg_view)
...
![image-20260908193210268](https://official-oss.oss-cn-hongkong.aliyuncs.com/docs/20260908193210320.jpg_view)
...
数据集上传成功后，可在`Datahub`—`My Datasets`中查看，数据集基本信息查看功能详细见[数据集基本信息查看](./4.Dataset-Overview)。
