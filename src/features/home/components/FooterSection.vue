      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-2">
          ...
          <p class="text-base-content/50 text-sm leading-relaxed max-w-2xl">
            ...
            worldwide to visualize the molecular complexity of life with unprecedented clarity and
            speed.
          </p>
        </div>
        ...
        <div>
          ...
          <div class="flex flex-col gap-3">
            <!-- Email -->
            <a
              href="mailto:jydong@xmu.edu.cn"
              class="flex items-center gap-2 text-base-content/50 hover:text-base-content transition-colors text-sm group w-fit"
            >
              <svg
            ...
            <!-- GitHub -->
            <a
              href="https://github.com/NeoNexusX/MassFlow"
              target="_blank"
              class="flex items-center gap-2 text-base-content/50 hover:text-base-content transition-colors text-sm group w-fit"
            >
            ...
            <!-- Lab Website -->
            <a
              href="https://bionet.xmu.edu.cn/index.htm"
              target="_blank"
              class="flex items-center gap-2 text-base-content/50 hover:text-base-content transition-colors text-sm group w-fit"
            >
              <svg
