...
<template>
  <BaseScene as="footer" align="between" class="footer-scene bg-base-300">
    ...
    <div v-reveal class="flex w-full flex-1 flex-col ">
      <p class="flex-1 pl-[0.8em] text-[clamp(1.5rem,10vw,6rem)] font-semibold uppercase tracking-[0.8em] text-secondary text-center">
      The Team
      </p>
      ...
      <div v-if="joinLinks.student || joinLinks.openSource" class="mt-[1.5em] flex flex-col items-center justify-center gap-[1em] sm:flex-row sm:gap-[3em]">
        <a
          ...
          class="btn btn-primary tracking-[0.1em] text-[clamp(1rem,2.5vw,1.75rem)] px-[2em] py-[0.9em]"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          class="btn btn-secondary tracking-[0.1em] text-[clamp(1rem,2.5vw,1.75rem)] px-[2em] py-[0.9em]"
        >Join on GitHub</a>
      </div>
    ...
    <!-- 品牌信息区 -->
    <div class="flex flex-2 w-full flex-col items-center gap-[0.6em] border-t border-base-content/10 pt-[1em] text-center text-[1rem] md:items-end md:text-right">
