...
export const METADATA_FIELDS: MetadataFieldDef[] = [
  ...
  { key: 'member_type', label: () => t('collections.meta.memberType'), type: 'list', group: 'general', options: MEMBER_TYPES, placeholder: () => t('collections.metaForm.placeholder.memberType'), required: true },
  { key: 'collection_type', label: () => t('collections.meta.collectionType'), type: 'list', group: 'general', options: COLLECTION_TYPES, placeholder: () => t('collections.metaForm.placeholder.collectionType'), required: true },
  // Citation
  ...
  // Sample
  { key: 'organism', label: () => t('common.meta.organism'), type: 'list', group: 'sample', options: ORGANISMS, required: true },
  { key: 'organism_part', label: () => t('common.meta.organismPart'), type: 'list', group: 'sample', options: ORGANISM_PARTS, required: true },
  { key: 'sample_stabilization', label: () => t('common.meta.sampleStabilization'), type: 'list', group: 'sample', options: SAMPLE_STABILIZATIONS, required: true },
  ...
  { key: 'polarity', label: () => t('common.meta.polarity'), type: 'list', group: 'acquisition', options: POLARITIES, required: true },
  { key: 'ionisation_source', label: () => t('common.meta.ionisationSource'), type: 'list', group: 'acquisition', options: ION_SOURCES, required: true },
  { key: 'analyzer', label: () => t('common.meta.analyzer'), type: 'list', group: 'acquisition', options: ANALYZERS, required: true },
]
