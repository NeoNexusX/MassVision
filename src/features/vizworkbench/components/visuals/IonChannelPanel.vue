<template>
  <div class="text-[1.125em]">
    ...
    <div v-if="disabled" class="text-base-content/60">
      Multi-ion overlay is only available for continuous data.
    </div>
...
const props = defineProps<{
  ...
  anyLoading: boolean
  /** True for processed data, where the overlay is unavailable. */
  disabled: boolean
  maxChannels: number
}>()
