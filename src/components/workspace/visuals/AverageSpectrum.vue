    ...
    <div class="flex items-center gap-3 mb-3">
      <div>
        ...
        <p class="text-sm text-base-content/50">
          Mean intensity across all pixels for each m/z
        </p>
      </div>
...
function renderChart(data: [number, number][]) {
  ...
  console.log('[AverageSpectrum] Container size:', container.clientWidth, 'x', container.clientHeight)
