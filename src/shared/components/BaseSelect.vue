<template>
  <div :class="['dropdown w-full', placement]">
    <div
      tabindex="0"
      role="button"
      class="select select-bordered w-full flex items-center text-left h-auto py-2"
      :class="extraClass"
    >
    ...
    <ul
      tabindex="0"
      class="dropdown-content menu bg-base-100 border border-base-300 rounded-box z-[100] w-full p-2 shadow-xl max-h-64 overflow-y-auto mt-1"
    >
